...
#[SearchApiParseMode(
  id: 'direct',
  label: new TranslatableMarkup('Direct query'),
  description: new TranslatableMarkup("Don't parse the query, just hand it to the search server unaltered. Might fail if the query contains syntax errors in regard to the specific server's query syntax."),
)]
