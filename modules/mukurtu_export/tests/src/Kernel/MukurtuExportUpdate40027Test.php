...
/**
 * Tests mukurtu_export_update_40027(), which grants Mukurtu Manager the
 * flag/unflag export-list permissions already held by Mukurtu Roundtrip
 * Manager.
 *
 * @see mukurtu_export_update_40027()
 */
#[Group('mukurtu_export')]
class MukurtuExportUpdate40027Test extends KernelTestBase {
