...
class CommunityHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getRevisionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision')) {
      ...
      $route
        ->setDefaults([
          '_controller' => '\Drupal\mukurtu_protocol\Controller\CommunityController::revisionShow',
  ...
  protected function getRevisionRevertRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_revert')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\mukurtu_protocol\Form\CommunityRevisionRevertForm',
  ...
  protected function getRevisionDeleteRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_delete')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\mukurtu_protocol\Form\CommunityRevisionDeleteForm',
  ...
  protected function getRevisionTranslationRevertRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('translation_revert')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\mukurtu_protocol\Form\CommunityRevisionRevertTranslationForm',
  ...
  protected function getSettingsFormRoute(EntityTypeInterface $entity_type) {
    if (!$entity_type->getBundleEntityType()) {
      ...
      $route
        ->setDefaults([
          '_form' => 'Drupal\mukurtu_protocol\Form\CommunitySettingsForm',
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    ...
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_mukurtu_permission', 'site:administer site configuration+community:update group+community:approve and deny subscription+community:manage members');
      return $route;
    }
  }
