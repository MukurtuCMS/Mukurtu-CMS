...
/**
 * Bulk-edits roles for selected community members.
 *
 ...
 */
#[Action(
  id: 'mukurtu_manage_community_roles_action',
  label: new TranslatableMarkup('Manage user roles in community'),
  confirm_form_route_name: 'mukurtu_protocol.community_manage_roles_form',
  type: 'og_membership',
)]
class MukurtuManageCommunityRolesAction extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a MukurtuManageCommunityRolesAction object.
   */
   ...
   * them. The actual role changes are made by ManageCommunityBulkRolesForm.
   */
  public function executeMultiple(array $entities) {
    $ids = array_map(fn($m) => $m->id(), $entities);
    $this->tempStoreFactory
      ->get('mukurtu_protocol.manage_community_roles')
