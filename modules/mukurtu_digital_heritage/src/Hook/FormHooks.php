...
class FormHooks {
  ...
  public function formNodeDigitalHeritageFormAlter(array &$form, FormStateInterface $form_state): void {
    ...
    $url = Url::fromRoute('entity.taxonomy_vocabulary.overview_form', ['taxonomy_vocabulary' => 'category']);
    $link = \Drupal::service('link_generator')->generate(t('add categories'), $url);
    $message = t('There are no categories available. Please @link before creating Digital Heritage items.', ['@link' => $link]);
