 ...
 * - mukurtu_core_update_40110() orders Security before Site information.
 * - mukurtu_core_update_40111() splits Site settings into "Publication tools"
 *   and "Local Contexts" sections.
 * - mukurtu_core_update_40113() moves "Site-wide comment settings" into
...
class DashboardLinkCleanupTest extends KernelTestBase {
  ...
  /**
   * mukurtu_core_update_40111() creates the two new dashboard menus and places
  ...
  /**
   * Running mukurtu_core_update_40111() twice does not duplicate blocks.
   */
  ...
  /**
   * mukurtu_core_update_40113() creates the "Notifications & Review" menu,
  ...
  /**
   * Running mukurtu_core_update_40113() twice does not duplicate the new
   * block (#2090).
   */
  ...
  /**
   * mukurtu_core_update_40113() grants "administer comments" to the Mukurtu
