...
class FormHooks {
  ...
  public function formNodeDictionaryWordFormAlter(array &$form, FormStateInterface $form_state): void {
    ...
    $url = Url::fromRoute('entity.taxonomy_vocabulary.overview_form', ['taxonomy_vocabulary' => 'language']);
    $link = \Drupal::service('link_generator')->generate(t('add languages'), $url);
    $message = t('There are no languages available. Please @link before creating Dictionary Words.', ['@link' => $link]);
