...
class MukurtuContentWarningsSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $view_mode_descriptions = [
      ...
      'collection_grid'             => $this->t('Media in Category teasers and Collection browse grid'),
      'collections_hero'            => $this->t('Hero image on Collection full page'),
      'image_with_description'      => $this->t('Media in image-with-description block content types'),
      'teaser_featured'             => $this->t('Media in Digital Heritage grid browse, teaser, and featured displays'),
      'full'                        => $this->t('Default full-page node view'),
      'large'                       => $this->t('Manual size option available when embedding media in HTML text fields; not tied to a configured display'),
      'media_assets'                => $this->t('Media Assets field on full page displays (Digital Heritage, Place, Person, Dictionary Word)'),
      'medium'                      => $this->t('Manual size option available when embedding media in HTML text fields; not tied to a configured display'),
      'small'                       => $this->t('Manual size option available when embedding media in HTML text fields; not tied to a configured display'),
      'dictionary_word_thumbnail'   => $this->t('Thumbnail field on Dictionary Word teasers'),
    ];
