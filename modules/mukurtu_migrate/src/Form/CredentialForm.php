...
/**
 * Mukurtu migrate database credential form.
 *
 * Heavily borrows from migrate_drupal_ui's CredentialForm.
 *
 * @internal
 */
class CredentialForm extends MukurtuMigrateFormBase {
  ...
  public function getFormId() {
    return 'migrate_migrate_credential_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['actions']['submit']['#value'] = $this->t('Review migration');

    $form['#title'] = $this->t('Migrate from a Mukurtu CMS version 3 site');
    ...
    $form['help'] = [
      '#type' => 'item',
      '#description' => $this->t('Provide the information to access the Mukurtu CMS version 3 site you want to upgrade. Files can be imported into the upgraded site as well.'),
    ];

    $migrate_source_version = '7';
    $form['version'] = [
      '#type' => 'hidden',
      '#value' => $migrate_source_version,
    ];
    ...
    $form['database'] = [
      ...
      '#description' => $this->t('Provide credentials for the database of the Mukurtu CMS site you want to migrate.'),
      '#open' => TRUE,
      '#states' => [
        'visible' => [
    ...
    $form['source']['d6_source_base_path'] = [
      ...
      '#description' => $this->t('To import files from your current Mukurtu CMS site, enter a local file directory containing your site (e.g. /var/www/docroot), or your site address (for example http://example.com).'),
      '#states' => [
        'visible' => [
    ...
    $form['source']['source_base_path'] = [
      ...
      '#default_value' => Settings::get('migrate_file_public_path') ?? '',
      '#description' => $this->t('To import public files from your current Mukurtu CMS site, enter a local file directory containing your site (e.g. /var/www/docroot), or your site address (for example http://example.com).'),
      '#states' => [
        'visible' => [
    ...
    $form['source']['source_private_file_path'] = [
      ...
      '#description' => $this->t('To import private files from your current Mukurtu CMS site, enter a local file directory containing your site (e.g. /var/www/docroot). Leave blank to use the same value as Public files directory.'),
      '#states' => [
        'visible' => [
          ':input[name="version"]' => ['value' => '7'],
        ],
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('mukurtu_migrate.review');
  }
